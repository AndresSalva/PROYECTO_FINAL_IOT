...
#define SOIL_DRY_PERCENT_THRESHOLD   33
#define SOIL_WET_PERCENT_THRESHOLD   66
#define SOIL_HYSTERESIS_PERCENT      5 
#define SOIL_CALIBRATION_DRY 4095
#define SOIL_CALIBRATION_WET 1400

// Higher ADC value means it's darker.
#define LIGHT_THRESHOLD      2000
#define LIGHT_HYSTERESIS     500 

// --- ACTUATOR PARAMETERS ---
#define SERVO_ANGLE_BRIGHT   0
#define SERVO_ANGLE_DARK     180
